...
namespace JABApiLib
{
    public static class JabApi
    {
        ...
        public extern static Boolean setTextContents(Int32 vmID, IntPtr ac, [MarshalAs(UnmanagedType.LPWStr)] string text);

        [DllImport(WinAccessBridgeDll, SetLastError = true, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)]
        public extern static Boolean requestFocus(Int32 vmID, IntPtr ac);

        //Gets basic version info about JVM/JAB
        [DllImport(WinAccessBridgeDll, SetLastError = true, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)]
        public extern static bool getVersionInfo(Int32 vmID, IntPtr versionInfo);
        ...
        [DllImport(WinAccessBridgeDll, SetLastError = true, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)]
        public extern static Boolean initializeAccessBridge();
